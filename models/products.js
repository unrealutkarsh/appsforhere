...
if (!mongoose.models.ProductModel) {
    module.exports = new productModel();
} else {
    module.exports = {
        ProductModel: mongoose.models.ProductModel,
        Image: mongoose.models.Image
    };
}

module.exports.getHereApiModel = function (req, next) {
...
module.exports.getLocalOrRemoteModelById = function (req, id, cb) {
    if (id === '_' || id === '-') {

...
var q = {
    ...
    init: function (db, config, options) {
        twilio = require('twilio')(config.get('twilio').sid, config.get('twilio').auth);
        twilioNumber = config.get('twilio').number;
        mailgunKey = config.get('mailgun').key;

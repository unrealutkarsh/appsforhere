...
Strategy.prototype.localInit = function (options) {
    this.statusURL = options.statusURL || 'https://api.paypal.com/retail/merchant/v1/status';
    this.profileURL = options.profileURL || 'https://api.paypal.com/v1/identity/openidconnect/userinfo/?schema=openid';
    this.hereApi = options.hereApi || hereApi;
    this.name = options.name || 'paypal';
};
    ...
    this._oauth2.get(this.profileURL, accessToken, function (err, body, res) {
        ...
        try {
            ...
            t.hereApi.get({
                ...
                console.log(statusErr,statusRz);
                if (statusRz) {

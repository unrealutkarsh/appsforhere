...
module.exports = function configurePassport(config) {
    ...
    passport.use(new PayPalStrategy({
        ...
        function (req, accessToken, refreshToken, profile, done) {
            savePassportUserToMongo(null, req, {at:accessToken, rt: refreshToken}, profile, done);
        }
    ));
    ...
    passport.use(new PayPalStrategy({
        ...
        function (req, accessToken, refreshToken, profile, done) {
            savePassportUserToMongo('sandbox', req, {at:accessToken, rt: refreshToken}, profile, done);
        }
    ));
    ...
    UserInfo.prototype.attachRequest = function (req) {
        ...
        this._tokens = {
            access_token_updated: function token_update(newToken) {
                self.request.session.access_token = newToken;
            },
